...
<!-- Short description: -->
  <h3>Make a Method to convert one value in Fahrenheit to value in Celsius, and show in Emacs</h3>

  ![Bilby Stampede](https://i.ytimg.com/vi/QFTDofic0Ek/maxresdefault.jpg)
</div>

## How to use

Declare the method in Emacs and call it by .fah_to_cel() in a second command

```magik
 (user)MagikSF> a << 50.5
 (user)MagikSf> a.fah_to_cel()
